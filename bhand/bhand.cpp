...
bhand::bhand(std::string dev_name)
{
...
void bhand::barett_hand_init()
{
    ...
    sleep(5);
    qDebug()<<"BHand Init successfully!\n";
...
Output: none.
*/
void bhand::check_error(__u32 result, std::string location_of_error)
{
...
void bhand::axisForce_init()
{
    ...
    sleep(2);
    qDebug()<<"6 axis force sensor init successfully!\n";
